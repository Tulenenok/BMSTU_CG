...
class XYForm:
    def __init__(self, root, color, text, widthEntry, command, btnText, padx=5, pady=10, width=10,
                 font=('Arial', 11, 'bold'), fg="#f1e4de", labels=["X: ", "Y: "]):
...
class XYXYForm:
    def __init__(self, root, color, text, widthEntry, command, btnText, padx=5, pady=10, width=10,
                 font=('Arial', 11, 'bold'), fg="#f1e4de", showButton=True):
    ...
    def show(self, color, posx=10, poxy=10):
        ...
        Label(self.f, text="X1: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=0)
        Label(self.f, text=" ", bg=color, font=('Arial', 1, 'bold'), fg="#f1e4de").grid(row=1)
        Label(self.f, text="Y1: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=2)
        Label(self.f, text=" ", bg=color, font=('Arial', 1, 'bold'), fg="#f1e4de").grid(row=3)
        Label(self.f, text="X2: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=4)
        Label(self.f, text=" ", bg=color, font=('Arial', 1, 'bold'), fg="#f1e4de").grid(row=5)
        Label(self.f, text="Y2: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=6)
...
class XYXForm:
    ...
    def show(self, color, posx=10, poxy=10):
        ...
        Label(self.f, text="αStart: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=0)
        Label(self.f, text=" ", bg=color, font=('Arial', 1, 'bold'), fg="#f1e4de").grid(row=1)
        Label(self.f, text="αEnd: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=2)
        Label(self.f, text=" ", bg=color, font=('Arial', 1, 'bold'), fg="#f1e4de").grid(row=3)
        Label(self.f, text="αStep: ", bg=color, font=('Arial', 10, 'bold'), fg="#f1e4de").grid(row=4)
        Label(self.f, text=" ", bg=color, font=('Arial', 1, 'bold'), fg="#f1e4de").grid(row=5)
